...
CREATE TABLE IF NOT EXISTS `ws_workshop` (
...
CREATE TABLE IF NOT EXISTS `ws_workshop_datum` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `datum` DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ws_account` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `naam` VARCHAR(80) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ws_cursist` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `naam` VARCHAR(80) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ws_betaling` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `datum` DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ws_inschrijving` (
  ...
  CONSTRAINT `fk_ws_inschrijving_ws_workshop_datum1`
    ...
    REFERENCES `ws_workshop_datum` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
